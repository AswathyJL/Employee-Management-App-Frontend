...
function App() {
  ...
  return (
    <>
      <h1 className='text-center mt-5 fw-bolder text-body-secondary'>Employee Management App</h1>
      ...
      <div className='d-flex justify-content-center align-items-center mt-5 '>
        <div className='rounded border  border-warning-subtle border-5 w-75'>
